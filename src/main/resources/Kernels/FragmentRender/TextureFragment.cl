...
)
{
    ...
    if (localIndex >= 0)
    {
        ...
        if (metaInfo[polygonIndex] == 1)
        {
            ...
            //A
            double p1x = relativeArray[polygonOffset + 0];
            double p1y = relativeArray[polygonOffset + 1];
            double p1z = relativeArray[polygonOffset + 2];
            //B
            double p2x = relativeArray[polygonOffset + (tIndex*3) + 0];
            double p2y = relativeArray[polygonOffset + (tIndex*3) + 1];
            double p2z = relativeArray[polygonOffset + (tIndex*3) + 2];
            //C
            double p3x = relativeArray[polygonOffset + ((tIndex+1)*3) + 0];
            double p3y = relativeArray[polygonOffset + ((tIndex+1)*3) + 1];
            double p3z = relativeArray[polygonOffset + ((tIndex+1)*3) + 2];
