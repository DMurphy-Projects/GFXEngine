...
public class GpuIntermediateRefPoint extends JoclProgram {
    ...
    public GpuIntermediateRefPoint(int screenWidth, int screenHeight, JoclSetup setup)
    {
    ...
    //----------EXTERNAL
    public void setupPointArray(IJoclMemory m)
    {
        clSetKernelArg(kernel, pointArrayArg, Sizeof.cl_mem, m.getObject());
    }
