...
//This is the example of using a method that handles higher vertex polygons
public class JoclTest08
{
    ...
    BarycentricGpuRender_v3 renderer;//is a specific test
    JoclTexture texture;
    ...
    public JoclTest08(int width, int height)
    {
        debug = SUCCINCT;
