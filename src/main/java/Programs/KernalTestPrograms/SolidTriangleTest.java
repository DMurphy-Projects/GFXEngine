...
public class SolidTriangleTest {
    ...
    SolidTriangleRender renderer;//is a specific test
    JoclTexture texture;
    ...
    public SolidTriangleTest(int width, int height)
    {
        debug = SUCCINCT;
        ...
        renderer = new SolidTriangleRender(screenWidth, screenHeight);
    ...
    private void updateScreen()
    {
        ...
        for (int i=0;i<clipPolys.size();i++)
        {
            ...
            renderer.render(clipPolys.get(i), null, null);
        }
        t.time();
